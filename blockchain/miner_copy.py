...
def valid_proof(last_hash, proof):
    ...
    prev_hashed_proof = hashlib.sha256(f"{last_hash}".encode()).hexdigest()
    if guess_hash[:5] == prev_hashed_proof[-5:]:
        return True
...
if __name__ == '__main__':
    ...
    while True:
        ...
        data = r.json()
        # print(data, "THIS IS THE DATA") ==> {'proof': 0.11229603536687183} THIS IS THE DATA
